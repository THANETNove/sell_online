...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ URL::asset('assets/img/core-img/logo-icon.png') }}" />
                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-header small text-uppercase">
                            <span class="menu-header-text">Manu</span>
                        </li>
                        <li class="menu-item">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                                <div data-i18n="Account Settings">หมวดหมู่สินค้า</div>
                            </a>
                            <ul class="menu-sub">
                                <li class="menu-item">
                        ...
                        <li class="menu-item">
                            <a href="javascript:void(0);" class="menu-link menu-toggle">
                                ...
                                <div data-i18n="Authentications">สินค้า</div>
                            </a>
                            <ul class="menu-sub">
                                <li class="menu-item">
                                    <a href="{{ url('/home') }}" class="menu-link">
