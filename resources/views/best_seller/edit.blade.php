                ...
                <div class="card">
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7 col-lg-12 mb-12">
                            <div class="card-body">
                                <h5 class="card-title text-primary">เเก้ไข สินค้าขายดี 🎉 <span style="float:right;"> <a href="{{url('/best-seller')}}" class="btn btn-sm btn-outline-primary">กลับ</a></span></h5>
                                <form method="POST" action="{{url('/update-best-seller',$image->id )}}"  enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
